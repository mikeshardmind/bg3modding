...
local broken_warn_formats = {
    NotSpell = "[Sorcerer] Spell list %s contained something other than a spell. The bad entry is named %s",
    ...
    MissingSpell = "[Sorcerer] Spell list %s contained a spell that isn't defined named %s",
    InvalidSpellName = "[Sorcerer] Spell list: %s contains an invalid spell name",
