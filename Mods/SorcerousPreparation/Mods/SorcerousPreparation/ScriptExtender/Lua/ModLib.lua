...
local defaultConfig = {
    ...
    rituals_always_prepared = false,
    disable_preparation_requirements = false,
}

local invalid_config_messages = {
    ["boolean"] = '[SorcerousPreparation] Invalid entry for key "%s" (expected: true or false) in config file, disabling mod'
}
...
local broken_warn_formats = {
    NotSpell = "[SorcerousPreparation] Spell list %s contained something other than a spell. The bad entry is named %s",
    InvalidSpellLevel = "[SorcerousPreparation] The spell named %s has an invalid level",
    InvalidSpellContainerID = "[SorcerousPreparation] The spell named %s has an invalid container ID specified",
    MissingSpell = "[SorcerousPreparation] Spell list %s contained a spell that isn't defined named %s",
    InvalidSpellName = "[SorcerousPreparation] Spell list: %s contains an invalid spell name",
    InvalidRitualCosts = "[SorcerousPreparation] The spell named %s has invalid ritual costs",
}
