...
local broken_warn_formats = {
    NotSpell = "[Bard] Spell list %s contained something other than a spell. The bad entry is named %s",
    ...
    MissingSpell = "[Bard] Spell list %s contained a spell that isn't defined named %s",
    InvalidSpellName = "[Bard] Spell list: %s contains an invalid spell name",
